...
const CrudPage = () => {
    ...
    return (
        <div className='px-3'>
            <Button onClick={() => setShow(true)} variant='success' className='my-2'>Yeni Görev Ekle </Button>
            ...
            <Table variant='dark' bordered striped hover>
                ...
                {state.tasks.map((task, index) => (
                    <TableBody deleteButton={() => dispatch(removeTask(task.id))} key={index} taskInfo={task} taskId={index} />
                ))}
            </Table>
